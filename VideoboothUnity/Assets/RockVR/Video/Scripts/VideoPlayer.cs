...
namespace RockVR.Video
{
    public class VideoPlayer : MonoBehaviour
    {
        ...
        public void PlayVideo()
        {
            ...
            this.GetComponent<UnityEngine.Video.VideoPlayer>().url = videoFiles[index];
            Debug.Log("[VideoPlayer::PlayVideo] Video Path:" + videoFiles[index]);
            videoPlayerImpl.Play();
        }

        public void PlayLastVideo() {
            this.GetComponent<UnityEngine.Video.VideoPlayer>().url = videoFiles[videoFiles.Count - 1];
            Debug.Log("[VideoPlayer::PlayVideo] Video Path:" + videoFiles[videoFiles.Count - 1]);
            videoPlayerImpl.Play();            
        }
        /// <summary>
        /// Turn to next video
